...
from scr.YandexWordstatPy.regions import get_wordstat_by_regions
from scr.YandexWordstatPy.regions_utils import pretty_regions


def yandex_wordstat_py(keyword, OAuth):
    """

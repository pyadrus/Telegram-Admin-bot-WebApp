...
<u>{username_admin}</u> – 🔗 связь с администратором (разработчиком).
'''

user_info = " Приветствую тебя, пользователь! Я рад видеть тебя в моем боте! Данный бот был создан, что бы облегчить тебе работу в администрировании твои групп и каналов. Следи за моим проектом, будет много новых функций и обновлений. "
